...
public class CreateDatabaseFileChooser extends JPanel {
	private Statement stmt;
	private static final CreateDatabaseFileChooser instance = new CreateDatabaseFileChooser();
	private static SqlSessionFactory sqlSessionForReset;
	private String q = "";

	public static CreateDatabaseFileChooser getInstance() {
		return instance;
	}
